...
class ThemePresets:
    ...
    TECH_MODERN = {
        "name": "科技现代",
        "description": "深色代码感，适合技术、编程、数码类文章",
        "body": {
            "font_size": "15px",
            "line_height": "1.75",
            "color": "#c9d1d9",
        ...
        "link": {
            "color": "#58a6ff",
            "text_decoration": "none",
            "border_bottom": "1px solid rgba(88, 166, 255, 0.4)"
        },
        "strong": {
            "font_weight": "bold",
            "color": "#f0f6fc"
    ...
    DARK_MINIMAL = {
        "name": "暗黑极简",
        "description": "暗色调极简风格，适合夜间阅读、游戏、二次元类文章",
        "body": {
            "font_size": "15px",
            "line_height": "1.75",
            "color": "#e2e8f0",
        ...
        "h1": {
            ...
            "margin": "24px 0 16px 0",
            "padding": "0 16px",
            "text_shadow": "0 0 10px rgba(99, 179, 237, 0.3)"
        },
        "h2": {
            "font_size": "17px",
            "font_weight": "bold",
        ...
        "link": {
            "color": "#63b3ed",
            "text_decoration": "none",
            "border_bottom": "1px solid rgba(99, 179, 237, 0.4)"
        },
        "strong": {
            "font_weight": "bold",
            "color": "#f7fafc"
